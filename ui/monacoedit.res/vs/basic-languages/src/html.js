...
define("vs/basic-languages/src/html", [ "require", "exports" ], function(e, t) {
    ...
    var n = "undefined" == typeof monaco ? self.monaco : monaco, i = [ "area", "base", "br", "col", "embed", "hr", "img", "input", "keygen", "link", "menuitem", "meta", "param", "source", "track", "wbr" ];
    t.conf = {
        ...
        ignoreCase: !0,
        tokenizer: {
            root: [ [ /<!DOCTYPE/, "metatag", "@doctype" ], [ /<!--/, "comment", "@comment" ],[ /<!/, "comment2", "@comment2" ], [ /(<)((?:[\w\-]+:)?[\w\-]+)(\s*)(\/>)/, [ "delimiter", "tag", "", "delimiter" ] ], [ /(<)(script)/, [ "delimiter", {
                token: "tag",
                next: "@script"
            } ] ], [ /(<)(style)/, [ "delimiter", {
                token: "tag",
            ...
            comment2: [ [ />/, "comment2", "@pop" ], [ /./, "comment2.content" ] ],
