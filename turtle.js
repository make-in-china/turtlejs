...
(function(){
    ...
    function addBindInfo(obj,name,target,targetName,event){
        ...
        bindInfoHash.push({name:name,target:target,targetName:targetName,event:event,enable:true});
    }
            ...
            if(!t.isBinding){
                ...
                for(var i=0;i<t.list.length;i++){
                    ...
                    if(obj!==this){
                        var o=obj.__bind__;
                        for(var j in o){
                            if(o[j].enable&&o[j].targetName===name){
        ...
        if(cdtn.length==2){
            ...
            if(eventName){
                node.addEventListener(eventName,function(){
                    var c=getBindInfo(node,elementValueName,name);
                    c.enable=false;
