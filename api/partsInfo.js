var partsInfo=[
    ...
    },
    {
        name:"元件和控制",
        data:[
                {name:"button",sortPath:"ui",desc:"按钮",icon:"../images/button.png"},
                {name:"colorfont",sortPath:"ui",desc:"多彩文字",icon:"../images/colorfont.png"},
                {name:"input",sortPath:"ui",desc:"手机弹出置顶输入框",icon:"../images/input.png"},
                {name:"inputbox",sortPath:"ui",desc:"置顶输入框",icon:"../images/input.png"},
                {name:"move",sortPath:"ui",desc:"转变内容为移动组件",icon:"../images/move.png"},
                {name:"scrollbar",sortPath:"ui",desc:"滚动条",icon:"../images/scrollbar.png"},
                {name:"xhr",sortPath:"ui",desc:"xmlhttprequest组件",icon:"../images/xhr.png"},
                {name:"timer",sortPath:"ui",desc:"定时器",icon:"../images/timer.png"},
                {name:"tooltip",sortPath:"ui",desc:"提示信息",icon:"../images/tooltip.png"}
            ]
    },
	{
		name:"IDE",
		data:[
                {name:"consolepanel",sortPath:"ui",desc:"调试器",icon:"../images/debugger.png"}
			]
	}
]