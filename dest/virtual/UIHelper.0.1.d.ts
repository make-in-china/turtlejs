...
declare abstract class VDOM2 extends VDOM {
    private static varNameKeyWordFirst;
    private static varNameKeyWord;
    protected static attrVarNameFilterParamBlock(html: string, m: IMember2): void;
    protected static attrVarNameFilter(html: string, m: IMember2): void;
    protected static dot(html: string, m: IMember2): void;
    protected static attrValue2(html: string, m: IMember2): void;
    protected static setAttr(html: string, m: IMember2): void;
    protected static attributes(html: string, m: IMember2): void;
    protected static textNode(html: string, m: IMember2): void;
    protected static getInitData(vNode: VMDOM.VNode & IVNodeMethod | undefined, length: number): IMember2;
}
declare let VHtmlElement_attributesToJS: () => string;
declare function toClassName(this: void, node: VMDOM.VNode): string;
declare function isConst(value: string): boolean;
declare function isStringConst(value: string): boolean;
interface IVNodeMethod {
...
declare namespace JS {
    ...
    function getLogic(statement: JavaScriptStatement, firstTryNames: string[]): JavaScriptLogic | null;
    /**合并连续空格
...
declare namespace OrderEx {
    function getBlocksDataString(data: Order.IOrderDataBlock): string[];
}
declare namespace OrderEx {
}
declare namespace OrderEx {
...
declare namespace UIHelper {
    function getScriptString(className: string): string;
    function getViewString(className: string, propertyInfo: string, varInfo: string, domInitScript: string, scripts: string, props: string, defaultValuesInfo: string): string;
    function getClassString(className: string): string;
}
interface IRefs {
    name: string;
...
declare class RefInfo {
    ...
    getRefNodeName(node: VMDOM.VHtmlElement & IVNodeMethod): string;
    push(name: string, refNode: VMDOM.VHtmlElement & IVNodeMethod): void;
    static getRefParentName(refs: IRefs[]): string;
}
declare namespace UIHelper {
    let fs: any;
    function buildProject(this: void, className: string, path: string): void;
}
declare namespace PartParamFilter {
    function bool(v: any): boolean;
    function intmin(v: any, p: any): any;
    function string(v: any): string;
    function floatmin(v: any, p: any): any;
    function int(v: any): number;
    function float(v: any): number;
    function pxtoem(v: any, p: any): string;
    function color(v: any): any;
    function date(v: any, p: any): string;
    function only(v: any, p: any): any;
    /**undefined to true */
    function udftotrue(v: any): any;
    /**any to true */
    function anytotrue(v: any): any;
    /**undefined to false */
    function udftofalse(v: any): any;
    /**any to false */
    function anytofalse(v: any): any;
    /**undefined to null */
    function udftonull(v: any): any;
    /**any to null */
    function anytonull(v: any): any;
    function udftoemptystr(v: any): any;
    function anytoemptystr(v: any): any;
}
...
declare namespace UIHelper {
    function makeClass(this: void, path: string, className?: string): void;
}
